...
public class OutPutBean {
	...
	private List<OutPutDetailBean> detailBeanList;// 明细表

	public List<OutPutDetailBean> getDetailBeanList() {
		return detailBeanList;
	}

	public void setDetailBeanList(List<OutPutDetailBean> DetailBeanList) {
