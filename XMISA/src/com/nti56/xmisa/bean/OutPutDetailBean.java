...
public class OutPutDetailBean {
	...
	// public InPutDetailBean() {
	// this.lossBeans = new ArrayList<LossRecordBean>();
	// }

	private List<OutPutThirdBean> thirdBeanList;

	public List<OutPutThirdBean> getThirdBeanList() {
		return thirdBeanList;
	}

	public void setThirdBeanList(List<OutPutThirdBean> thirdBeanList) {
